...
During the \the\year\ Ross Program, I, \blank{3in}{parent/guardian name}{parent.name}, the parent/guardian of \blank{2in}{student name}{name} (the ``Participant''), can be reached at \blank{2in}{phone number}{phone.number}.
