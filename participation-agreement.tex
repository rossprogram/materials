...
On this \blank{1in}{\hspace{1em} date}{date}, I, \blank{3in}{\hspace{1em}  parent/guardian name
 }{parent}, as parent or guardian, \\[5pt]
 give permission for \blank{2in}{\hspace{1em} student name }{name} to attend the Ross Mathematics Program \\[5pt]
...
\item[Early Departure Agreement:] In the event that the Ross
  ...
  \blank{2in}{\hspace{1em} email}{email} and via telephone and text message at
  \blank{1.5in}{\hspace{1em} phone}{phone}. \\[5pt]
