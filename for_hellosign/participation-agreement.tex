...
On this \genblank[date]{\phantom{\hspace{1in}}}, I, \genblank[parent/guardian name]{\phantom{\hspace{3in}}}, 
as parent or guardian,
give permission for \genblank[student name]{\phantom{\hspace{2in}}} to attend the Ross Mathematics Program. 
...
\item[Early Departure Agreement:] In the event that the Ross
  ...
  \begin{itemize}
    ...
    \item \genblank[additional phone]{\phantom{\hspace{2in}}} 
  \end{itemize}
